    ...
    <>
      ...
      <div className='d-flex justify-content-between mt-3'>
        <div className='text-center mt-3 ms-3'>
          ...
          <form action="">
            <input
              className='rounded border border-bold ps-2 w-75'
              type="text"
              value={searchKey}
              onChange={(e)=>setSearchkey(e.target.value)}
              placeholder='You can type and search here...'
            />
          </form>
        </div>
      ...
      <Row className='container-fluid mb-5 mt-5'>
        {allReports?.length>0 ?
          ...
          allReports?.map((item)=>(
            <Col className='mb-3' sm={12} md={6} lg={4} key={item._id}>
              ...
              {isLogin &&
                <div
                  ...
                  className="d-flex justify-content-center rounded mt-1"
                >
                  <div>
                    <button
          ...
          <div>
            {isToken ?
              ...
              <p
                style={{color:'red',fontWeight:'600px'}}
                className='text-center fs-3'
              >
                <b>Sorry no reports currently available</b>
              </p>
              ...
              <div className='d-flex justify-content-center align-items-center flex-column'>
                ...
                <p className='fs-3 mt-4 text-danger'>
                  <b>Please</b>{" "}
                  <Link
