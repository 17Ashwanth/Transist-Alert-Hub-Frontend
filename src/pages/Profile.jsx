...
// NOTE: BASE_URL import is removed — no longer needed for images!
        ...
        <Row>
          <Col className='d-flex align-items-center' lg="6">
            <h3 className="text-center text-light">
              ...
              "Revolutionize Your Profile: Transform, Update, and Stay Ahead with Transist Alert Hub!"
            </h3>
          </Col>
          <Col lg='6'>
            <div className="d-flex align-items-center justify-content-center flex-column">
              ...
              <div className='d-flex justify-content-center'>
                <label htmlFor='profile'>
                  ...
                  {/* CHANGED: was `${BASE_URL}/uploads/${existingImage}` 
                      NOW: just use existingImage directly — it's already a full Cloudinary URL */}
                  {existingImage==""
                    ? <img className='mt-5 ms-5 rounded-circle' height={'250px'} width={'250px'} src={preview?preview:avatar} alt="no image" />
                    : <img className='mt-5 ms-5 rounded-circle' height={'250px'} width={'250px'} src={preview?preview:existingImage} alt="no image" />
                  }
